...
<aside class="cc-sidebar" id="ccSidebar" aria-label="Employee sidebar">
  ...
  <!-- NAV -->
  <nav class="cc-nav">
    <a href="<?= BASE_URL ?>/admin/dashboard.php" class="<?= is_active('dashboard.php')?'active':'' ?>">
      <span class="icon">🏠</span>
      <span class="label">Dashboard</span>
      <span class="tooltip">Dashboard</span>
    </a>

    <a href="<?= BASE_URL ?>/admin/attendance.php" class="<?= is_active('attendance.php')?'active':'' ?>">
      <span class="icon">⏱️</span>
      <span class="label">Attendance</span>
      <span class="tooltip">Attendance</span>
    </a>

    <a href="<?= BASE_URL ?>/admin/leaves.php" class="<?= is_active('leaves.php')?'active':'' ?>">
      <span class="icon">📝</span>
      <span class="label">Leaves</span>
      <span class="tooltip">Leaves</span>
    </a>

     <a href="<?= BASE_URL ?>/admin/announcements.php" class="<?= is_active('announcements.php')?'active':'' ?>"><span class="icon" aria-hidden="true">
    ...
    <a href="<?= BASE_URL ?>/admin/documents.php" class="<?= is_active('documents.php')?'active':'' ?>">
      <span class="icon">📂</span>
      <span class="label">Documents</span>
      <span class="tooltip">Documents</span>
    </a>

    <a href="<?= BASE_URL ?>/admin/profile.php" class="<?= is_active('profile.php')?'active':'' ?>">
      <span class="icon">👤</span>
      <span class="label">My Profile</span>
      <span class="tooltip">Profile</span>
    </a>

    <a href="<?= BASE_URL ?>/admin/settings.php" class="<?= is_active('settings.php')?'active':'' ?>">
      <span class="icon">⚙️</span>
